...
def luminosity_distance_mpc(redshifts):
    """Reference flat cosmology: H0=70, Om=0.3, Ode=0.7, no radiation.

    Use the actual cosmo_params.h numbers, not its misleading Planck-2018 label.
    Zero-redshift fluxes require an independent distance, not division by zero;
    that alternative distance API is not implemented in this initial stage.
    """
